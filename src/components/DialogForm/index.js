  ...
  return (
    ...
    <div className='overlay'></div>
        <div className='contact-form pop'>
            <span className='fa fa-close popClose' onClick={() => setIsPDF(false)}></span>
            ...
            <form ref={form} onSubmit={sendEmail}>
                ...
                <input type="pageName" name="pageName" value={page} placeholder='pageName' className='hide' required/>
