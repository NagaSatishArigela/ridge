...
const blogSec = [
    {
        ...
        description: "Initially limited to Hyderabad's downtown, real estate activity expanded as the city experienced a boom",
        link: "https://ridgehomes.in/blog/uncategorized/auto-draft/",
    },
    {
        image: blog2,
        title: "Focused in West Hyderabad",
        description: "It is no secret that the cost of real estate in Hyderabad is not just rising but also exploding.",
    ...
    },
    {
        ...
        description: "The southern half of the city's real estate market has just begun to pick up, particularly ",
...
const bannerContent = [
    ...
    {
        text1: '"It is the unfailing fall of rain that sustains the world. Therefore, look upon rain as the nectar of life."',
        text2: ' - Tirukural'
    }
]
...
{
      item.title ? <> <img src={item?.image} alt="blog image" />
      {
...
function HomeSections() {
      const randomItem = bannerContent[Math.floor(Math.random()*bannerContent.length)];
  ...
  return (
    <>
      <div className='hBanner'>
        ...
        {randomItem.text1} <span>{randomItem.text2} <br />An inspiration for Ridge</span>
        </div>
      </div>
      <section>
