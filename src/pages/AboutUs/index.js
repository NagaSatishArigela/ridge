          ...
          {teamMembers.map((member, index) => (
            <div className="teamMember" key={index}>
              ...
              <div className="teamDetails">
                <h3 style={{fontFamily: "sans-serif", fontSize: '35px', fontWeight: '900', margin: "25px 0px"}}>{member.name}</h3>
                <h4>{member.title}</h4>
                <p>{member.description}</p>
                <div className="socialLinks">
                  <a href={member.facebook}><i className="fa fa-facebook"></i></a>
                  <a href={member.linkedin}><i className="fa fa-linkedin"></i></a>
                  <a href={member.twitter}><i className="fa-brands fa-x-twitter"></i></a>
                </div>
              </div>
            </div>
          ))}
