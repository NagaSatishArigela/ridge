      ...
      <div className="terms-conditions">
        ...
        <ol type="a">
          <li>
            ...
            materials (data or programming) on Ridge Homes's site for individual
            and non-business use only. This is the just a permit of license and
            ...
            <ol type="i">
              ...
              <li>
                ...
                contained on Ridge Homes's site;
              </li>
              <li>
                remove any copyright or other restrictive documentations from
                the materials; or
              </li>
              <li>
          ...
          <li>
            ...
            these confinements and may be ended by Ridge Homes whenever deemed.
        ...
        {/* Continue structuring the rest of the content similarly */}
        <h2>3. Disclaimer</h2>
        <ol type="a">
          <li>
            The materials on Ridge Homes's site are given "as is". Ridge Homes
            makes no guarantees, communicated or suggested, and thus renounces
            and nullifies every single other warranties, including without
            impediment, inferred guarantees or states of merchantability,
            fitness for a specific reason, or non-encroachment of licensed
            property or other infringement of rights. Further, Ridge Homes does
            not warrant or make any representations concerning the precision,
        ...
        <h2>4. Constraints</h2>
        <p>
          In no occasion should Ridge Homes or its suppliers subject for any
          ...
          utilization or powerlessness to utilize the materials on Ridge Homes's
          Internet webpage, regardless of the possibility that Ridge Homes or a
          Ridge Homes approved agent has been told orally or in written of the
        ...
        <p>
          The materials showing up on Ridge Homes's site could incorporate
          typographical, or photographic mistakes. Ridge Homes does not warrant
          that any of the materials on its site are exact, finished, or current.
          Ridge Homes may roll out improvements to the materials contained on
          its site whenever without notification. Ridge Homes does not, then
          again, make any dedication to update the materials.
        </p>

        <h2>6. Links</h2>
        <p>
          Ridge Homes has not checked on the majority of the websites or links
          ...
          infer support by Ridge Homes of the site. Utilization of any such
          connected site is at the user's own risk.
        </p>

        <h2>7. Site Terms of Use Modifications</h2>
        <p>
          Ridge Homes may update these terms of utilization for its website
        ...
        <p>
          Any case identifying with Ridge Homes's site should be administered by
          the laws of the country of India Ridge Homes State without respect to
        ...
        <p>
          ...
          disclose and make utilization of individual information. The following
        ...
        <ul>
          ...
          <li>
            ...
            the target of satisfying those reasons indicated by us and for other
          ...
          <li>
            Personal information ought to be important to the reasons for which
            it is to be utilized, and, to the degree essential for those
