...
function SunRiseLanding() {
  return (
     <>
     <Helmet>
        <meta name="title" content="#1 HMDA Open plots in sultanpur hyderabad || Sunrise city" />
...
<li>Overhead water tank with waterlines
        ...
        <HomeContact  page="Sunrise Landing" noContact={true} conactDetails={sunriseContact} banner={ContactBanner} />
